    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == CropImage.CROP_IMAGE_ACTIVITY_REQUEST_CODE) {
            ...
            if (resultCode == RESULT_OK) {
                ...
                final UploadTask uptask = filepath.putFile(resultUri);
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        Task<Uri> urlTask = uptask.continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
                            ...
                            public void onComplete(@NonNull Task<Uri> task) {
                                Log.e("urlfnal", task.getResult().toString());
                                        ...
                                        Task<Uri> urlTask = uploadTask.continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
                                            ...
                                            public void onComplete(@NonNull Task<Uri> thumb_task) {
                                                if (thumb_task.isSuccessful()) {
                                                    ...
                                                    mProgressDialog.dismiss();
                                                    Toast.makeText(SettingsActivity.this, "Error in Uploading Thumblaiin.", Toast.LENGTH_LONG).show();
                                                }
                                            }
                                        });
                                    }
